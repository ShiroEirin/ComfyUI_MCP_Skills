...
COMPATIBILITY_MATRIX: tuple[CompatibilityCell, ...] = (
    ...
    CompatibilityCell(
        "phase-h-observability-apis",
        "comfyui-api",
        "capability-aware-optional",
        (
            "jobs_api",
            "userdata_v2",
        ...
        (
            "optional endpoint 404 is unsupported",
            "optional endpoint 401 or 403 is unauthorized",
            "optional endpoint 5xx is temporarily unavailable",
            "optional endpoint failure does not mark server offline",
        ),
        "unit",
        "implemented",
        "working-tree",
        "tests/test_phase_h_mcp.py",
    ),
    CompatibilityCell(

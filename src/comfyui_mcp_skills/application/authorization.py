...
_TOOL_SCOPES: dict[str, frozenset[Scope]] = {
    ...
    "comfyui.admin.workflow.change.plan": frozenset({Scope.AUTHOR}),
    "comfyui.admin.workflow.change.commit": frozenset({Scope.AUTHOR}),
    ...
    "comfyui.runtime.restart.approve": frozenset({Scope.OPERATE}),
    "comfyui.runtime.restart.commit": frozenset({Scope.OPERATE}),
    "comfyui.runtime.restart.get": frozenset({Scope.OPERATE}),
